...
class LiquidactionController extends Controller
{
    ...
    public function index(Request $request)
    {
       try {
            ...
            return view('wallet.index', compact('pamm','pammTotal','pammAvailable','comisionRange','rangeTotal','rangeTotal','rangeAvailable','licencias','licenciasTotal','licenciasAvailable',
