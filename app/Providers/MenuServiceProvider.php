...
class MenuServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // menu Soporte
        $verticalMenuJsonS = file_get_contents(base_path('resources/data/menu-data/verticalMenuSoporte.json'));
        $verticalMenuDataS = json_decode($verticalMenuJsonS);
        ...
        View::share('menuData',[$verticalMenuDataU, $verticalMenuDataA, $verticalMenuDataS]);
    }
}
