...
(function(window, document, $) {
    ...
    $('.nav-link-style').on('click', function() {
        ...
        saveAppTheme(switchToLayout);
    })
    // Cambia el 
    async function saveAppTheme(mode)
    {
        mode = mode.replace('-layout', '');
        const route = "/change/color/app"
        axios.post(route,{
            mode
        })
    ...
    function setLayout(currentLocalStorageLayout) {
        ...
        if (switchToLayout === 'dark-layout') {
            ...
            navLinkStyle.removeAttr("checked")
            ...
            navLinkStyle.attr("checked", "checked")
