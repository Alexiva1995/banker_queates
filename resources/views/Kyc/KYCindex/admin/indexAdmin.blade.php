            ...
            <div class="col-sm-12 d-flex justify-content-center">
                ...
                <div class="col-sm-12">
                    <div class="table-responsive" id="table">
                        <table class="table nowrap scroll-horizontal-vertical myTable " id="myTable">
                            <thead class="">
                                    ...
                                    <tr>
                                       ...
                                       <td>{{'usuario'}}</td>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            ...
                                            <button class="btn btn-info"  type="button"  data-bs-toggle="modal" data-bs-target="#frontModal{{ $K->user_id }}"><i class="fa fa-credit-card" aria-hidden="true"></i> Espalda del documento</button>
                                        </td>

                                        <td>
                                            <form method="POST" action="{{route('KYC-accion')}}">
                                                @csrf
                                                <button type="submit" name="aprovar" value="{{ $K->user_id  }}" class="btn btn-success me-1"><i class="fa fa-check" aria-hidden="true" ></i> Aprobar</button>
