    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content p-75">
        <div class="modal-header">
          <h4 class="modal-title fw-700" id="title_bonus">Verificacion</h4>
            ...
            <div id="body_bonus">
                ...
                <div class="input-group mb-2 shadow-none">
                    <div class="input-group input-group-merge shadow-none">
                        ...
                        <span class="btn input-group-btn text-primary cursor-pointer border-end input-group-text border-top border-bottom" id="codeButton_bonus" onclick="getCode_bonus();" >Obtener codigo</span>
                    </div>
                </div>
            </div>

            <div class="d-flex justify-content-center" id="contenedorspiner_bonus" hidden>
                <i class="fa-solid fa-circle-notch rotate" style="color: #673DED; font-size: 7rem;" id="spiner_bonus"hidden></i>
            </div>
        ...
        <div class="modal-footer" id="footer_bonus">
            ...
            <button type="button" class="btn btn-primary" onclick="verificarRetiro_bonus();">Continuar</button>
        </div>
      </div>
    </div>
  </div>
