...
<div class="container">
  ...
  <ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item me-2 zoom" role="presentation">
      <div class=" active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">
      <div class="card p-1">
        ...
        <div class="texto">
            <h3 class="fw-700 mb-25">USDT {{number_format($availableBalanceComision,2)}} </h3>
            <p class="font-medium-2 mb-0">Comisiones Disponible </p>
        </div>
    </div>
  </div>
    </li>
    @if($day_available == 'si')
      <li class="nav-item zoom me-2" role="presentation">
        <div class="" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
        <div class="card p-1">
          <div class="avatar bg-light-primary avatar-md me-auto mb-1 custom-avatar-content p-50">
              <div class="avatar-content">
                  <svg width="21" height="18" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="texto">
              ...
              @if(isset($BonusRange))
                <h3 class="fw-700 mb-25">USDT {{number_format($BonusRange,2)}}</h3>
              @else
              <h3 class="fw-700 mb-25">USDT 0</h3>
              @endif
              <p class="font-medium-2 mb-0">Bonos Rango Disponible</p>
          </div>
        </div>
      </div>
    </li>
        ...
        <li class="nav-item  me-2" role="presentation">
          <div class="" >
          <div class="card p-1" style="background-color: #e9e9e9">
            <div class="row">
              <div class="col-sm-6">
                <div class="avatar bg-light-primary avatar-md me-auto mb-1 custom-avatar-content p-50">
                  <div class="avatar-content">
              ...
              <div class="col-sm-6">
                <span class="fw-700 mb-25" style="font-size: 0.8rem">Solo disponbibles del 1 al 7 del mes</span>
              </div>
            </div>
            <div class="texto">
                @if(isset($BonusRange))
                ...
                <h3 class="fw-700 mb-25">USDT 0</h3>
                @endif
                <p class="font-medium-2 mb-0">Bonos Rango no Disponibles</p>
            </div>
          </div>
        </div>
      </li>
  ...
  <li class="nav-item zoom " role="presentation">
    <div class="" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">
    <div class="card p-1">
      <div class="avatar bg-light-primary avatar-md me-auto mb-1 custom-avatar-content p-50">
          <div class="avatar-content">
              <svg width="21" height="18" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="texto">
          @if(isset($BonusRange))
            <h3 class="fw-700 mb-25">USDT {{number_format($utilidades,2)}} </h3>
          @else
          <h3 class="fw-700 mb-25">USDT 0</h3>
          @endif
          <p class="font-medium-2 mb-0">Utilidades Disponible</p>
      </div>
    </div>
  </div>
</li>
  ...
  <div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
      @include('business.ui.componentes.tipos-retiros.bonos.bonos')    
    </div>
    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
    @include('business.ui.componentes.tipos-retiros.utilidades.utilidades')    
    </div>
  </div>
