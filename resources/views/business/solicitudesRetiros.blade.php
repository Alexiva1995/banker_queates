...
<div id="logs-list">
    <div class="col-12">
        <div class="d-flex my-1">
            <p class="fw-700 mb-0">Wallets</p><span class="fw-300 mx-1 text-primary">|</span>
            <p class="fw-300 mb-0">Withdrawal</p>
        </div>
        <div class="card p-75">
            <div class="card-content">
                <div class="card-header">
                    <div class="mt-2 d-flex justify-content-start"><h4 class="fw-700">Latest withdrawals</h4></div>
                        ...
                        <table class="table w-100 nowrap scroll-horizontal-vertical myTable table-striped w-100">
                            <thead class="">
                                <tr class=" text-center">
                                    ...
                                    <th class="fw-600 d-none d-md-table-cell">Amount</th>
                                ...
                                <tr class="text-center">
                                    ...
                                    @elseif($retiro->status ==1)
                                            <button class="btn bg-light-success" style="color: #28C76F;">
                                                <a href="https://tronscan.org/#/transaction/${{$retiro->hash}}" class="text-decoration-none text-success">Paid</a>
                                            </button>
                                    @else
                                            <button class="btn bg-light-danger" style="color: red;">
                                                <a href="https://tronscan.org/#/transaction/${{$retiro->hash}}" class="text-decoration-none text-danger">Cancelled</a>
                                            </button>
                                    @endif
                                    </td>
                                    ...
                                    <td class="d-none d-md-table-cell">
                                        {{$retiro->hash !== null ? $retiro->hash : 'Not Available'}}
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
