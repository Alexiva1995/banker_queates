      ...
      <form action="" id="form-withdrawal" method="post">
        ...
        <div class="card-body p-0" >
          <div class="row row-gap d-flex justify-content-end">
            ...
            <div class="col-md-6 col-sm-6 ">
              ...
              <div class="input-group">
                <input type="text" id="wallet"onkeyup="w();" onpaste="var e = this; pegar(e);" required id="fee" name="wallet" class="form-control" placeholder="Ingresa tu wallet">
              </div>
            </div>
            ...
            <div class="col-md-6 col-sm-6 ">
                ...
                <div class="input-group" style="margin-bottom: 6px;">
                  <input type="hidden"  value="{{$availableBalanceComision}}" id="avaibleBalanceTotal">
                  <input type="number" id="Monto_a_retirar" onkeyup="activarInput(this.value)" name="Monto_a_retirar" class="form-control rounded-start" placeholder="Introduzca el monto" required>
                  <span  class="input-group-text fw-bold rounded-end bg-transparent ">USD <label onclick="max();" style="cursor: pointer;" class="text-primary ms-1" style="padding-inline-start: 6px;"> MAX</label></span>
                </div>
                      ...
                      <div class="col-md-12">
                          <div class="row">
                              ...
                              <div class="col-md-6 d-flex justify-content-end">
                                  <span >{{number_format($availableBalanceComision,2)}}</span>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-12">
          ...
          <div class="modal-footer mt-1" style="border-top: none;">
            ...
            <button type="button" data-bs-toggle="modal" data-bs-target="#exampleModalComision" id="continue-button" class="btn btn-primary ms-1" disabled>Continuar</button>
          </div>
        </div>
            </form>
                </div>
