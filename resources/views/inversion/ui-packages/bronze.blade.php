<div class="tab-pane fade show active" id="nav-bronze" role="tabpanel" aria-labelledby="nav-bronze-tab">
    <div class="row contain">
                        ...
                        <div class="contenedor-irv tres-irv ">
                            ...
                            <article class="entrada-irv">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <label class="card-content-tittle" id="bronze_deposit">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <label class="card-content-tittle" id="bronze_rentability">
                                        -
                                    </label>
                            ...
                            <article class="entrada-irv">
                                ...
                                <div class="col-sm-12">
                                    <label class="card-content-tittle" id="bronze_date">
                                        -
                                    </label>
                                ...
                                <div class="col-sm-12 mt-2">
                                    <label class="card-content-tittle" id="bronze_membership">
                                ...
                                <div class="col-sm-12 mt-2">
                                    <label class="card-content-tittle" id="bronze_status">
                                        -
                                    </label>
                                    <p class="primary-color">
                                        Estado
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tbody>
                                    @if ($bronzePackage->utilities->count() > 0)
                                        @foreach ($bronzePackage->utilities as $utility)
                                            <tr class="text-center">
        ...
        @else
            <div class="no-inversion mb-5">
                ...
                <a href="{{ route('broncePackages') }}" class="btn text-white" style="background: var(--bs-primary);">
                    Comprar paquete
                </a>
            </div>
        @endif
