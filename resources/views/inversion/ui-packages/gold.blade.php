<div class="tab-pane fade show" id="nav-gold" role="tabpanel" aria-labelledby="nav-gold-tab">
    <div class="row contain">
                        ...
                        <div class="contenedor-irv tres-irv ">
                            ...
                            <article class="entrada-irv">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <label class="card-content-tittle" id="gold_deposit">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <label class="card-content-tittle" id="gold_rentability">
                                        -
                                    </label>
                            ...
                            <article class="entrada-irv">
                                ...
                                <div class="col-sm-12">
                                    <label class="card-content-tittle" id="gold_date">
                                        -
                                    </label>
                                ...
                                <div class="col-sm-12 mt-2">
                                    <label class="card-content-tittle" id="gold_membership">
                                ...
                                <div class="col-sm-12 mt-2">
                                    <label class="card-content-tittle" id="gold_status">
                                        -
                                    </label>
                                    <p class="primary-color">
                                        Estado
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tbody>
                                    @if ($goldPackage->utilities->count() > 0)
                                        @foreach ($goldPackage->utilities as $utility)
                                            <tr class="text-center">
        ...
        @else
            <div class="no-inversion" style="margin-bottom: 280px">
                ...
                <a href="{{ route('oroPackages') }}" class="btn text-white" style="background: var(--bs-primary);">
                    Comprar paquete
                </a>
            </div>
        @endif
