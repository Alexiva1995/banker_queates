<div class="tab-pane fade show" id="nav-platinum" role="tabpanel" aria-labelledby="nav-platinum-tab">
    <div class="row contain">
        @if ($platinumPackage !== 0)
                        ...
                        <div class="contenedor-irv tres-irv ">
                            ...
                            <article class="entrada-irv">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <label class="card-content-tittle" id="platinum_deposit">
                                        {{number_format($bronzePackage->invested, 2, ',', '.').' USDT'}}
                                    </label>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <label class="card-content-tittle" id="platinum_rentability">
                                        -
                                    </label>
                            ...
                            <article class="entrada-irv">
                                ...
                                <div class="col-sm-12">
                                    <label class="card-content-tittle" id="platinum_date">
                                        -
                                    </label>
                                ...
                                <div class="col-sm-12 mt-2">
                                    <label class="card-content-tittle" id="platinum_membership">
                                        {{number_format($bronzePackage->membershipPackage->amount, 2, ',', '.').' USDT'}}
                                    </label>
                                    <p class="primary-color">Membresía</p>
                                </div>

                                <div class="col-sm-12 mt-2">
                                    <label class="card-content-tittle" id="platinum_status">
                                        -
                                    </label>
                                    <p class="primary-color">
                                        Estado
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tbody>
                                    @if ($platinumPackage->utilities->count() > 0)
                                        @foreach ($platinumPackage->utilities as $utility)
                                            <tr class="text-center">
        ...
        @else
            <div class="no-inversion" style="margin-bottom: 280px">
                ...
                <a href="{{ route('platinoPackages') }}" class="btn text-white" style="background: var(--bs-primary);">
                    Comprar paquete
                </a>
            </div>
        @endif
