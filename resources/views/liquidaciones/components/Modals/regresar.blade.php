  ...
  <!-- Modal -->
  <div class="modal fade" id="regresarModal{{$liquidacion->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">To return</h5>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="input-group mb-1">
                        ...
                        <input id="wallet{{$liquidacion->id}}" value="{{$liquidacion->wallet_used}}" type="text" class="form-control" placeholder="{{$liquidacion->decryptWallet()}}" aria-label=" " aria-describedby="basic-addon1" readonly="readonly">          
                        <span onclick="copyToClipBoard_regresar({{$liquidacion->id}});" style="cursor: pointer;" class="input-group-text" onclick><i class="fa-solid fa-copy"></i></span>
                      </div>
                </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="regresar({{ $liquidacion->id }} , 'regresar')">Return</button>
        </div>
      </div>
    </div>
  </div>
