                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                            <tr>
                                <td style="color: #626262; font-family: Arial, sans-serif; display:block">
                                    <h2 style="font-size: 24px; margin: 0;">Solicitud de retiro</h2>
                                </td>
                                <td style="color: #626262; font-family: Arial, sans-serif; display:block; margin-top: 10px">
                                    <p style="font-size: 19px; margin: 0;">Estimad@ {{$user}}</p>
                                </td>
                                <td style="color: #626262; font-family: Arial, sans-serif; display:block; margin-top: 10px">
                                    <p style="font-size: 19px; margin: 0;">Total a recibir : ${{$total}}</p>
                                </td>
                                <td style="color: #626262; font-family: Arial, sans-serif; display:block; margin-top: 10px">
                                    <p style="font-size: 19px; margin: 0;">Este es su codigo de retiro pendiente, vigente por solo 30 minutos</p>
                                </td>
                                <td style="color: #626262; font-family: Arial, sans-serif; display:block; margin-top: 10px">
                                    <p style="font-size: 19px; margin: 0;">Código: ${{$code}}</p>
                                </td>
                            </tr>
                            <tr>
