                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                            ...
                            <tr>
                                <td style="color: #626262; font-family: Poppins, sans-serif; font-size: 16px; line-height: 24px; text-align: justify; padding: 10px 0 15px 0;">
                                    <p style="margin: 0; font-size: 20px; color:#4d4c4c; font-weight:700">¡Bienvenido!</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="color: #626262; font-family: Poppins, sans-serif; font-size: 16px; line-height: 24px; text-align: justify; padding: 10px 0 10px 0;">
                                    <p style="margin: 0; font-size: 18px;">Felicidades has actualizado tu formulario con exito, esta sera procesada en un lapso maximo de 48 horas ( sábados y domingos no se incluyen), Bienvenido a Connect.</p>
                                </td>
                            </tr>
