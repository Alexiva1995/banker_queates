                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                            <tr>
                                <td style="color: #626262; font-family: Arial, sans-serif;">
                                    <h1 style="font-size: 24px; margin: 0;">Felicidades, {{$name}}</h1>
                                </td>
                            </tr>
                            <tr>
                                <td style="color: #626262; font-family: Poppins, sans-serif; font-size: 16px; line-height: 24px; text-align: justify; padding: 20px 0 30px 0;">
                                    <p style="margin: 0;">Tu retiro por {{$amount}} USD fue confirmada éxitosamente.</p>
                                    <p style="margin: 0;">Estamos muy felices de aportar un vehículo financiero para llegar a caminos de abundancia.</p>
                                    <p style="margin: 0;">Gracias por confiar en Connect.</p>
                                    <p style="margin: 0;">Yesterday’s dreams, todays reality.</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
