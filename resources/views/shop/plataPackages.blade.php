...
<div class="container-fluid container-custom">
    <div class="d-flex my-1">
        <p class="fw-700 mb-0">Paquetes</p><span class="fw-300 mx-1 text-light">|</span><p class="fw-300 mb-0">Paquetes Plata</p>
    </div>
    ...
    <div id="adminServices" class="mt-1">
        ...
        <div class="row justify-content-center">
            <div class="alert alert-info d-flex p-1 my-75">
                ...
                Tu paquete será llevado al 200.2%, en donde ese 200.2% incluye el 100% del capital aportado. Es decir, traes 10.000 y sales con 20.020. Dicho de otra manera: Recibes tus 10.000 Y 10.020 de Ganancia. En total recibes 20.020
            </div>
                        ...
                        <div class="d-flex justify-content-center">
                            @if ($package->image != null)
                                <div class="card rounded-0 mb-0 border-0" style="width: 80%;">
                                    <img src="{{ asset('images/MembershipsPackage/Plata/' . $package->image) }}"
