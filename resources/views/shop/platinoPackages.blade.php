...
<div class="container-fluid container-custom">
    <div class="d-flex my-1">
        <p class="fw-700 mb-0">Paquetes</p><span class="fw-300 mx-1 text-light">|</span><p class="fw-300 mb-0">Paquetes Platino</p>
    </div>
    ...
    <div id="adminServices" class="mt-1">
        ...
        <div class="row justify-content-center">
            <div class="alert alert-info d-flex p-1 my-75">
                ...
                Tu paquete será llevado al 200.2%, en donde ese 200.2% incluye el 100% del capital aportado. Es decir, traes 10.000 y sales con 20.020. Dicho de otra manera: Recibes en el mes 7 tus 10.000 y en el mes 14 recibes 10.020 de Ganancia. En total recibes 20.020. Estos paquetes Platino no aceleran con los bonos, es decir, todo lo que se genere por bonos de Inicio Rápido, Bonos Residual, Bonos P7K, serán ganancial adicional sin afectar el pasivo.
            </div>
                ...
                <div class="col-md-4 col-lg-3 col-sm-4 wm-27">
                    <div class="card">
                        <div class="d-flex justify-content-center">
                            @if ($package->image != null)
                                <div class="card rounded-0 mb-0 border-0" style="width: 80%;">
                                    <img src="{{ asset('images/MembershipsPackage/Platino/' . $package->image) }}"
                        ...
                        <div class="card-body px-sm-2">
                            ...
                            <h2 class="fw-600 mb-75">{{ $package->rentability }}% <small>/ 14 meses</small></h2>
