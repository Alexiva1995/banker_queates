                ...
                <nav class="links col-sm-5">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        aria-controls="nav-bnb" aria-selected="false">
                            <div class="card-body card-dashboard">
                                <img
                                src="https://icons.iconarchive.com/icons/cjdowner/cryptocurrency-flat/128/Binance-Coin-BNB-icon.png"
                                alt="" height="24">
                                BNB
                            </div>
                        </button>
                ...
                <div class="row">
                    ...
                    <div class="col-sm">
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                <img src="{{ asset('images/Qr/'.$wallettrc20[0]['image'])}}" alt="qr" style="width: 72%;">
                                <input type="hidden" name="moneda" value="{{$wallettrc20[0]['type']}}">
                                <input type="text" id="wallet" class="clipboard mt-1" value="{{$wallettrc20[0]['wallet']}}" style="width:275px;border:none;">
                                <span>
                    ...
                    <div class="col-sm">
                            <div class="col-12 mt-1">
                                ...
                                <input name="type" type="text" class="w-100 form-control" value="{{$type}}" disabled required>
                            </div>
                            <div class="col-12 mt-1">
                                <label for="amount" class="form-label w-100">{{ __('Monto:') }}</>
                                <input name="amount" type="number" class="w-100 form-control" style="display: block !important;" value="{{$amount}}" disabled>
                            </div>
                            <div class="col-12 mt-1">
                                <label for="voucher" class="form-label w-100">{{ __('Comprobante de pago:') }}</>
                                <input name="voucher" type="file" class="w-100 form-control" style="display: block !important;" required>
                            </div>
                            <div class="col-12 mt-1">
                            ...
                            <div class="modal-footer mt-2" style="padding-left:1px;">
                                {{-- <button type="button" class="btn btn-secondary" href="{{route('')}}">volver</button>--}}
